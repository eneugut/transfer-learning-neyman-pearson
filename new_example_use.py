...
if __name__ == "__main__":
    ...
    target_normal_data = sample_multivariate_normal(num_features, 0.0, 100)
    ...
    data_dict = {
        ...
        "source_normal_data": source_normal_data,
    ...
    # Run TLNP
    tlnp_results = TLNP.run_new_tlnp(config_path, data_dict, model)
