...
if __name__ == "__main__":
    ...
    c_eps0T_minus = 0.01   # for ε0T_minus used in α - ε0T_minus
    ...
    climsim_config = {
        ...
        "targets": [26],              # keep these rows for TARGET split
        "sources": [27],        # keep these rows for SOURCE split
    ...
    theta_hat, R1S_hat_theta, _ = solve_min_R1S_final(
        ...
        lam_cap=None, init_model=theta_alphaT_model, x1S=x1S,
